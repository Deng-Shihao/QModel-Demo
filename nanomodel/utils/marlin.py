...
def gptq_marlin_gemm(a: torch.Tensor,
    ...
    return nanomodel_marlin_kernels.gptq_marlin_gemm(a, c, b_q_weight, b_bias, b_scales,
...
def gptq_marlin_repack(b_q_weight: torch.Tensor, perm: torch.Tensor,
    ...
    return nanomodel_marlin_kernels.gptq_marlin_repack(b_q_weight, perm, size_k, size_n,
                                                       num_bits)
