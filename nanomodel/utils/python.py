...
def log_gil_requirements_for(feature: str):
    log.warn.once(
        f"Feature `{feature}` requires Python < 3.14 and Python GIL enabled and Python >= 3.13.3T (T for Threading-Free edition of Python) plus Torch 2.8. Feature is currently skipped/disabled."
    )
