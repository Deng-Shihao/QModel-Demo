...
try:
    nanomodel_marlin_kernels = load_extension_module("nanomodel_marlin_kernels")
...
def _transform_param(layer: torch.nn.Module, name: Optional[str], fn: Callable) -> None:
...
def gptq_marlin_gemm(
    ...
    return nanomodel_marlin_kernels.gptq_marlin_gemm(
        a,
        c,
        b_q_weight,
        b_bias,
...
def gptq_marlin_repack(
    ...
    return nanomodel_marlin_kernels.gptq_marlin_repack(
